...
test('Renders App, clicks button, selects season 1 from dropdown, checked for two episodes rendered out from mock data', async () => {
    ...
    expect( screen.getAllByTestId( /episode/i ))
        .toHaveLength( 2 )
})